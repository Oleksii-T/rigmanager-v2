                ...
                <div class="social-buttons">
                    ...
                    @if (\App\Models\Setting::get('apple_auth_enabled'))
                        <a href="{{route('auth.social', 'apple')}}" class="social-apple">
                            <img src="{{asset('icons/apple.svg')}}" alt="apple logo">
                        </a>
                    @endif
                </div>
