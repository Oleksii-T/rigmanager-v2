    ...
    <div class="holder">
        <div class="header-block">
            ...
            <div class="header-logo">
                <a href="#"><img src="{{asset('icons/logo-big.svg')}}" alt=""></a>
            </div>
            ...
            <div class="mob-nav">
                <div class="holder">
                    ...
                    <ul class="mob-nav-list">
                        <li><a href="#">{{__('ui.introSellEq')}}</a></li>
                        <li><a href="#">{{__('ui.introBuyEq')}}</a></li>
                        <li><a href="#">{{__('ui.introSe')}}</a></li>
                        <li class="hidden"><a href="#">{{__('ui.introTender')}}</a></li>
                    </ul>
                    <ul class="mob-nav-list">
