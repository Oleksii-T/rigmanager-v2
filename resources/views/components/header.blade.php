            ...
            <div class="header-search">
                ...
                <div class="header-search-form">
                    <form action="{{route('search')}}">
                        <fieldset>
                            <input type="text" name="search" class="header-search-input" placeholder="@lang('ui.search')" required>
                ...
                <div class="header-cabinet">
                    @auth
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('profile.favorites')}}">
