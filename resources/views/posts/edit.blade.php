                            ...
                            <div class="row">
                                <div class="col-6 rci">
                                    <label class="label rci-label">
                                        ...
                                        <div class="check-block">
                                            <div class="check-item">
                                                <input type="checkbox" name="is_double_cost" class="check-input" id="is_double_cost" @checked($post->is_double_cost)>
                                    ...
                                    <div class="rci-content">
                                        ...
                                        <div class="rci-input">
                                            <input type="text" name="cost_per" class="input" placeholder="pc." value="{{$post->cost_per}}">
                                        </div>
                                    </div>
