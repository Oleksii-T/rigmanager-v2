...
@section('style')
    <style>
        ...
        .note-editor.note-frame.focused, .note-editor.note-frame:hover {
            border: 1px solid #ff8d11 !important;
        }
        .note-toolbar {
        ...
        .note-frame, .note-frame h2, .note-frame h3 {
            color: #999999 !important;
        }
        .note-frame ul {
            padding-left: 14px;
        ...
        .note-dropdown-menu h2, .note-dropdown-menu h3 {
            color: #999999 !important;
        }
        ...
        .note-dropdown-item p, .note-dropdown-item h2, .note-dropdown-item h3, .note-dropdown-item h4 {
            transition: all 0.3s linear;
        }
        .note-dropdown-item:hover p, .note-dropdown-item:hover h2, .note-dropdown-item:hover h3, .note-dropdown-item:hover h4 {
            color: #ff8d11 !important;
        }
    </style>
...
@section('content')
    <div class="main-block">
        <div class="content">
            ...
            <h2 style="color:red">TEST DEV PAGE</h2>
                ...
                <form id="form-post" method="POST" action="{{route('posts.store')}}">
                    ...
                    <fieldset>
                        <div class="form-section"> <!--title+category+cost+type+desc-->
                            ...
                            <textarea cols="30" rows="10" maxlength="9000" class="textarea posts-rich-desc" name="description" form="form-post"></textarea>
